...
# 输出结果：
# Attention result shape: (batch_size, query_seq_length, units): (64,
# 2, 1024)
# Attention weights shape: (batch_size, query_seq_length, value_seq_length): (64,
# 2, 18)
